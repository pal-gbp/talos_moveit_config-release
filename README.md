## talos_moveit_config (humble) - 2.0.4-1

The packages in the `talos_moveit_config` repository were released into the `humble` distro by running `/usr/bin/bloom-release --track humble --rosdistro humble talos_moveit_config -y` on `Wed, 11 Feb 2026 08:57:55 -0000`
...
## talos_moveit_config (humble) - 2.0.2-1

The packages in the `talos_moveit_config` repository were released into the `humble` distro by running `/usr/bin/bloom-release --track humble --rosdistro humble talos_moveit_config -y` on `Wed, 18 Jun 2025 14:11:53 -0000`
...
## talos_moveit_config (humble) - 2.0.1-1
